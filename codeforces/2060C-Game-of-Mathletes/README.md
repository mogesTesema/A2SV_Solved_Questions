...
**Problem:** [2060C-Game-of-Mathletes](https://codeforces.com/contest/2060/problem/C)
...
Alice and Bob are playing a game. There are n (n is even) integers written on a blackboard, represented by x_1, x_2, …, x_n. There is also a given integer k and an integer score that is initially 0. The game lasts for \frac{n}{2} turns, in which the following events happen sequentially:
...
The first line of each test case contains two integers n and k (2 ≤q n ≤q 2⋅ 10⁵, 1 ≤q k ≤q 2⋅ n, n is even).

The second line of each test case contains n integers x_1,x_2,…,x_n (1 ≤q x_i ≤q n) — the integers on the blackboard.
