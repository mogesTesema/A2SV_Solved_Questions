...
**Problem:** [1343C-Alternating-Subsequence](https://codeforces.com/contest/1343/problem/C)
...
The first line of the test case contains one integer n (1 ≤ n ≤ 2 ⋅ 10⁵) — the number of elements in a. The second line of the test case contains n integers a_1, a_2, …, a_n (-10⁹ ≤ a_i ≤ 10⁹, a_i ≠ 0), where a_i is the i-th element of a.
